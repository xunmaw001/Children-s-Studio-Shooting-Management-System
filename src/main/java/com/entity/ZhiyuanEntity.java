 ...
 */
@TableName("zhiyuan")
public class ZhiyuanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhiyuanEntity() {

	}

	public ZhiyuanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zhiyuan{" +
            ...
            ", zhiyuanPhoto=" + zhiyuanPhoto +
            ", sexTypes=" + sexTypes +
            ", zhiyuanPhone=" + zhiyuanPhone +
            ", zhiyuanIdNumber=" + zhiyuanIdNumber +
            ", zhiyuanEmail=" + zhiyuanEmail +
            ", zhiyuanDelete=" + zhiyuanDelete +
