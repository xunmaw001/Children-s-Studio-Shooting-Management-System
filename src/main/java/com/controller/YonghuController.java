...
//                            yonghuEntity.setYonghuName(data.get(0));                    //顾客姓名 要改的
...
//                            yonghuEntity.setYonghushenfenTypes(Integer.valueOf(data.get(0)));   //身份 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "顾客");
        R r = R.ok();
        r.put("token", token);
        r.put("role","顾客");
