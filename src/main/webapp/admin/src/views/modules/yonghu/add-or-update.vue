        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="顾客姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="顾客姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身份" prop="yonghushenfenTypes">
                        <el-select v-model="ruleForm.yonghushenfenTypes" :disabled="ro.yonghushenfenTypes" placeholder="请选择身份">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="身份" prop="yonghushenfenValue">
                        <el-input v-model="ruleForm.yonghushenfenValue"
