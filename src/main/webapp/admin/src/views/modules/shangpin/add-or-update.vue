        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="套餐类型" prop="shangpinTypes">
                        <el-select v-model="ruleForm.shangpinTypes" :disabled="ro.shangpinTypes" placeholder="请选择套餐类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="套餐类型" prop="shangpinValue">
