<template>
    <div style="backgroundImage: url('/ertongyingloupaishe/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">儿童影楼拍摄管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="顾客姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="顾客姓名"  />
                        </el-form-item>
                        ...
                        <el-form-item label="职员姓名" class="input" v-if="tableName=='zhiyuan'">
                            <el-input v-model="ruleForm.zhiyuanName" autocomplete="off" placeholder="职员姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='zhiyuan'">
                            <el-input v-model="ruleForm.zhiyuanPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="身份证号" class="input" v-if="tableName=='zhiyuan'">
                            <el-input v-model="ruleForm.zhiyuanIdNumber" autocomplete="off" placeholder="身份证号"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='zhiyuan'">
                            <el-input v-model="ruleForm.zhiyuanEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.zhiyuanName)&& 'zhiyuan'==this.tableName){
                                this.$message.error('职员姓名不能为空');
                                return
                            }
                             if('zhiyuan' == this.tableName && this.ruleForm.zhiyuanPhone&&(!this.$validate.isMobile(this.ruleForm.zhiyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zhiyuanIdNumber)&& 'zhiyuan'==this.tableName){
                                this.$message.error('身份证号不能为空');
                                return
                            }
                            if('zhiyuan' == this.tableName && this.ruleForm.zhiyuanEmail&&(!this.$validate.isEmail(this.ruleForm.zhiyuanEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
